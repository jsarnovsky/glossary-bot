...
It is a simple web app designed to be used as a [Slack integration](https://slack.com/integrations). Specifically, it responds to POSTs created by the Slack _Slash Commands_ integration and responds with messages to Slack's _Incoming Webhooks_ integration.
